...
public class CrmReceivableDO extends BaseDO {
     ...
     */
    private String no;
    // TODO “对应实体”，参考别的模块，关联 {@link TableField.MetaInfo#getJdbcType()}
    /**
     * 回款计划
     *
     * TODO 这个字段什么时候更新，也可以写下
     *
     ...
     * 客户 ID
     *
     * 对应实体 {@link cn.econets.blossom.module.crm.dal.dataobject.customer.CrmCustomerDO}
     */
     ...
     * 审核状态
     *
     * 枚举 {@link cn.econets.blossom.module.crm.enums.common.CrmAuditStatusEnum}
     */
