...
public class MpMenuBaseVO {
    ...
    @Schema(description = "网页链接", example = "https://www.econets.cn/")
    ...
    @Schema(description = "回复的媒体 URL", example = "https://www.econets.cn/xxx.jpg")
    @NotEmpty(message = "回复的消息 mediaId 不能为空",
            groups = {ImageMessageGroup.class, VoiceMessageGroup.class, VideoMessageGroup.class})
    ...
    @Schema(description = "缩略图的媒体 URL",example = "https://www.econets.cn/xxx.jpg")
    ...
    @Schema(description = "回复的音乐链接", example = "https://www.econets.cn/xxx.mp3")
    ...
    @Schema(description = "高质量音乐链接", example = "https://www.econets.cn/xxx.mp3")
